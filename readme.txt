=== HikaShop to WooCommerce Migration ===
Contributors: LitExtension
Donate link: 
Tags: HikaShop to woocommerce, HikaShop to woocommerce migration, migrate HikaShop to woocommerce  
...
This plugin allows you to migrate your products, orders, customers, passwords and other data from HikaShop to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers, passwords and other data from HikaShop to WooCommerce automatically. 
...
 
= ADDITIONAL FEATURES =
* No Downtime: Data is migrated with no downtime for your current HikaShop store
...
* Migrate Recent Data: You have just finished a full migration, after that HikaShop is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from HikaShop to WooCommerce, NO third party involved
...
3. Go to the Plugins -> HikaShop to WooCommerce Migration


== Documentation and Support ==
Please visit [LitExtension FAQ section](http://litextension.com/woocommerce-migration-tool/HikaShop-to-woocommerce.html) if you have any questions about migration to WooCommerce.
